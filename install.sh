...
declare -a brewCask=('avast' 'calibre' 'discord' 'dropbox' 'evernote' 'firefox' 'flux' 'google-chrome' 'google-drive' 'google-hangouts' 'hyper' 'java' 'league-of-legends' 'postman' 'psequel' 'robomongo' 'sequel-pro' 'skype' 'slack' 'sourcetree' 'spotify' 'the-unarchiver' 'transmission' 'vlc');
